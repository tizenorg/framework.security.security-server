 ...
 *
 */
#ifndef SECURITY_SERVER_PASSWORD_PLUGIN_API_H
#define SECURITY_SERVER_PASSWORD_PLUGIN_API_H

#include <string>

#include <sys/types.h>

#define SECURITY_SERVER_PLUGIN_SUCCESS   0
#define SECURITY_SERVER_PLUGIN_FAIL      1
...
typedef PasswordPlugin* (*CreatePasswordPlugin_t)(void);      // function extern C named create
typedef void (*DestroyPasswordPlugin_t)(PasswordPlugin *ptr); // function extern C named destroy

} // namespace SecurityServer

#endif // PASSWORD_PLUGIN_API_H
