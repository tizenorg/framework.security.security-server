...
const size_t SHARED_FILE_QUOTA = (25 * 1024 * 1024);
const size_t SHARED_FILE_MAX_NUM = 200;
...
char const * const SERVICE_SOCKET_OPEN_FOR_UNPRIVILEGED =
    "/tmp/.security-server-api-open-for-unprivileged.sock";
char const * const SERVICE_SOCKET_OPEN_FOR_PRIVILEGED =
    "/tmp/.security-server-api-open-for-privileged.sock";
